...
<body>
	...
	<section class="header-section">
		...
		<div class="header-section__image">
			<img src="./images/Done.jpg" alt="image done" class="image-done">
		</div>
	</section>
	<section class="info">
	...
	<section class="finances">
		<div class="finances__image">
			<img src="./images/finances.jpg" alt="image finances" class="image-finances">
		</div>
	...
	<section class="deadline">
		...
		<div class="deadline__textblock">
			<p class="illustration-text">
				В мире, где столько всего интересного, когда же успевать жить?
			</p>
		</div>
		<div class="deadline__image">
			<img src="./images/mind_blowing1.jpg" alt="image mind blow" class="image-mind_blow">
		</div>
	</section>
